...
<tr class="tableRow"><td><input type="hidden" name="type_message" value="${type_message}"></td></tr>
<tr class="tableRow"><td><input type="submit" name="submit" value="goTeacherWelcome"></td></tr>
</table>
</form>
<br>
